...
<html>
	...
	<head>
		...
		<link rel="stylesheet" media="screen and (max-width: 1024px) and (orientation: portrait)" href="css/mobile.css" />
	</head>
	...
	<body>
			...
			<div class="subject">
				<div id="addWebsiteAddr" >
					...
					<div id="addWebsiteTheme">
						...
						<div>					<!-- TO DO : JS onclick event listener sur les span pour cocher les cases-->
							<span><input type="checkbox">Reseau Social</span>
							<span><input type="checkbox" checked>News</span>
							<span><input type="checkbox">Site de vente</span>
							<span><input type="checkbox">Boite Mail</span>
						</div>
				...
				<div id="lowerOptions">
					...
					<div id = "websiteVerification">
						...
						<select id="verif" size="1">
							<option value="60000" selected>Toutes les 1mn</option>
		...
		<script>
				...
				function addWebsite(){
					...
					var data_url = document.createElement("input");
					data_url.setAttribute("hidden","true");
					data_url.setAttribute("name","url");
					data_url.setAttribute("value",url.toString());
